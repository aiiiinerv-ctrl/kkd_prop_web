/* Minimal brand glyph (lucide-react ships no brand/social icons) — mirrors the
   local icon pattern already used in site-footer.tsx, kept here so it can be
   shared by the contact page and the home quick-contact row without a new
   dependency. */
