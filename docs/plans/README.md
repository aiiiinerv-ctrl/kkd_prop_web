...
| [calculator-config-sprints.md](calculator-config-sprints.md) | Calculator admin config Phase A/B — map [#102](https://github.com/aiiiinerv-ctrl/kkd_prop_web/issues/102) **deployed** |
| [calculator-excel-import-sprints.md](calculator-excel-import-sprints.md) | Calculator Excel size-table import S0–S10 — map [#143](https://github.com/aiiiinerv-ctrl/kkd_prop_web/issues/143) **in progress** |
| [calculator-excel-import-codex-handoff-tasks.md](calculator-excel-import-codex-handoff-tasks.md) | Codex hand-off 2026-09-26 — close S6/S7 from uncommitted WT |
| [page-banners-branding-sprints.md](page-banners-branding-sprints.md) | Page banners + header/footer logos — map [#107](https://github.com/aiiiinerv-ctrl/kkd_prop_web/issues/107) **deployed** |
