...
| [html-sitemap-sprints.md](html-sitemap-sprints.md) | HTML sitemap (Deestone-style) + admin config — map [#115](https://github.com/aiiiinerv-ctrl/kkd_prop_web/issues/115) |
